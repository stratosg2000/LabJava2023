...
*/
		...
		// Below is a good example of polymorphism --- same method add different set of parameters
		al.remove(2);	// remvove name using index position Steven   
		al.remove("John");  // remvoe using value 		John
		System.out.println(al);
		System.out.println("Search Lex"+al.contains("Lex"));
		System.out.println("Search Akash"+al.contains("Akash"));
		System.out.println("The index of Lex is : "+al.indexOf("Lex"));
