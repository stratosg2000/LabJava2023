package filemagic.menu.com;


import java.util.Scanner;
import filemagic.menu.com.FileMagicBusinessMenu;
import filemagic.service.com.FileMagicMainService;
...
public class FileMagicMainMenu {
	...
	public static void main(String[] args) {
		...
		char verifyExit; 	      // check for verification while asking y/n no
	...
	do {
		...
		case "1":FileMagicMainService list = new FileMagicMainService();
				 list.magicListFiles(scanner);	
		         break;
		         
		case "2":FileMagicBusinessMenu magicBusinessMenu = new FileMagicBusinessMenu();
		         magicBusinessMenu.displayBusinessMenu(scanner);
		         break;
		         
		case "0":System.out.println("Thank you for using FileMagic");
		         break;
		
		default:System.out.println("Invalid choice. Valid input values are <0-2>");
			    break;
		} 
