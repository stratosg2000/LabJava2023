...
import filemagic.service.com.FileMagicBusinessService;
...
public class FileMagicBusinessMenu {
	...
	public void displayBusinessMenu(Scanner scanner) {
		...
		case "0": FileMagicBusinessService add = new FileMagicBusinessService();
			      add.magicBusinness(scanner, "creating");
	              break;

		case "1": FileMagicBusinessService delete = new FileMagicBusinessService();
		          delete.magicBusinness(scanner, "deleting");
		          break;
	
		case "2": FileMagicBusinessService search = new FileMagicBusinessService();
